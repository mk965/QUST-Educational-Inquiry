...
<div class="weui-tab">
    <div class="weui-tab__panel">        <h1 class="title">青岛科技大学-教务登录</h1>
        <form action="/jiaowu/login" method="post" onsubmit="return loginCheck();">
            ...
            <div class="weui-cells__tips"style="color: red;">* 近期教务系统异常，如登录失败请稍后再试</div>
    ...
    <div class="weui-tabbar">
        <a href="/jiaowu/mian" class="weui-tabbar__item weui-bar__item_on">
        ...
        <a href="javascript:alert('该功能正在开发中...');" class="weui-tabbar__item">
            <img src="../image/logout.png" alt="校园卡查询" class="weui-tabbar__icon">
